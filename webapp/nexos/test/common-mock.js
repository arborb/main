...
//          $NC.G_MAIN.toggleMenu();
    ...
    $NC.serviceCall = function(requestUrl, requestData, onSuccessHandler, onErrorHandler, messageOptions, mockId) {
      ...
      if (localStorage.getItem('_MOCK') == 'true' && mockId) {
        return serviceMock(requestUrl, requestData, onSuccessHandler, onErrorHandler, messageOptions, mockId);
      }
      var ajaxData = {
        success: null,
        error: null
      ...
      $.ajax({
        ...
        complete: function(jqXHR, textStatus) {
          //removeServiceLog('serviceCall', args);
          // 성공, 실패에 대한 Event 호출
          if (ajaxData.success) {
