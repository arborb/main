...
function loadContents() {
  ...
  // 데이터 조회
  $NC.serviceCall("/CM03030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function _Save() {
  ...
  if (saveDS.length > 0) {
    $NC.serviceCall("/CM03030E/save.do", {
