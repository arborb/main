...
function _Initialize() {
  ...
  $NC.setInitMonthPicker("#dtpQInout_Month1", $NC.addMonth($NC.G_USERINFO.LOGIN_DATE, -11));
  $NC.setInitMonthPicker("#dtpQInout_Month2");
...
function _OnConditionChange(e, view, val) {
  ...
  case "BRAND_CD":
    ...
    return;
  case "INOUT_MONTH1":
    $NC.setValueMonthPicker(view, val, "검색 시작월을 정확히 입력하십시오.");
    break;
  case "INOUT_MONTH2":
    $NC.setValueMonthPicker(view, val, "검색 종료월을 정확히 입력하십시오.");
    break;
  }
...
function _Inquiry() {
  ...
  var INOUT_MONTH1 = $NC.getValue("#dtpQInout_Month1");
  if ($NC.isNull(INOUT_MONTH1)) {
    alert("검색 시작월을 입력하십시오.");
    $NC.setFocus("#dtpQInout_Month1");
    return;
  }
  var INOUT_MONTH2 = $NC.getValue("#dtpQInout_Month2");
  if ($NC.isNull(INOUT_MONTH2)) {
    alert("검색 종료월을 입력하십시오.");
    $NC.setFocus("#dtpQInout_Month2");
    return;
  }
  ...
  // 데이터 조회
  $NC.serviceCall("/LK02010Q/getDataSet.do", $NC.getGridParams(grdObject), onGetMaster);
}
