...
function callWbSaveProc() {
  ...
  $NC.serviceCall("/RO02010E/callWbSaveProc.do", {
    P_DS_MASTER: $NC.getParams(processDS)
  }, onGetWbSaveSP);
}
...
function grdMasterDOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/RO02010E/getDataSet.do", $NC.getGridParams(G_GRDDETAILD), onGetDetailD);
  ...
  // 데이터 조회
  $NC.serviceCall("/RO02010E/getDataSet.do", $NC.getGridParams(G_GRDSUBD), onGetSubD);
