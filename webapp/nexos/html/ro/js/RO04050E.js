...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/RO04050E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function onConfirmExecProc(center_Cd, bu_Cd, order_Date, order_No) {
  ...
  $NC.serviceCall("/RO04050E/callRoScanConfirm.do", {
    P_QUERY_ID: "RO_SCAN_LT_STEP2",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: center_Cd,
      P_BU_CD: bu_Cd,
      P_ORDER_DATE: order_Date,
