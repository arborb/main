...
function _Inquiry() {
  ...
  $NC.serviceCall("/LV03010Q/getDataSet.do", {
    P_QUERY_ID: "LV03010Q.RS_MASTER01",
    P_QUERY_PARAMS: P_QUERY_PARAMS
  }, onGetMaster01);

  $NC.serviceCall("/LV03010Q/getDataSet.do", {
    P_QUERY_ID: "LV03010Q.RS_MASTER02",
    P_QUERY_PARAMS: P_QUERY_PARAMS
  }, onGetMaster02);

  $NC.serviceCall("/LV03010Q/getDataSet.do", {
    P_QUERY_ID: "LV03010Q.RS_MASTER03",
    P_QUERY_PARAMS: P_QUERY_PARAMS
  }, onGetMaster03);

  $NC.serviceCall("/LV03010Q/getDataSet.do", {
    P_QUERY_ID: "LV03010Q.RS_MASTER04",
    P_QUERY_PARAMS: P_QUERY_PARAMS
  }, onGetMaster04);
...
function onGetMaster01(ajaxData) {
  ...
  if (rowCount === 0) {
    ...
    for (var row = 0; row < rowCount; row++) {
      ...
      seriesDate.push([rowData.DAY_DISP1, rowData.IN_QTY1]);
      seriesDate.push([rowData.DAY_DISP2, rowData.IN_QTY2]);
      seriesDate.push([rowData.DAY_DISP3, rowData.IN_QTY3]);
      seriesDate.push([rowData.DAY_DISP4, rowData.IN_QTY4]);
      seriesDate.push([rowData.DAY_DISP5, rowData.IN_QTY5]);
      seriesDate.push([rowData.DAY_DISP6, rowData.IN_QTY6]);
      seriesDate.push([rowData.DAY_DISP7, rowData.IN_QTY7]);
...
function onGetMaster02(ajaxData) {
  ...
  if (rowCount === 0) {
    ...
    for (var row = 0; row < rowCount; row++) {
      ...
      seriesDate = new Array();
      seriesDate.push([1, rowData.IN_QTY1]);
      seriesDate.push([2, rowData.IN_QTY2]);
      seriesDate.push([3, rowData.IN_QTY3]);
      seriesDate.push([4, rowData.IN_QTY4]);
      seriesDate.push([5, rowData.IN_QTY5]);
      seriesDate.push([6, rowData.IN_QTY6]);
      seriesDate.push([7, rowData.IN_QTY7]);
      seriesDate.push([8, rowData.IN_QTY8]);
      seriesDate.push([9, rowData.IN_QTY9]);
      seriesDate.push([10, rowData.IN_QTY10]);
      seriesDate.push([11, rowData.IN_QTY11]);
      seriesDate.push([12, rowData.IN_QTY12]);
      seriesDate.push([13, rowData.IN_QTY13]);
      seriesDate.push([14, rowData.IN_QTY14]);
      seriesDate.push([15, rowData.IN_QTY15]);
      seriesDate.push([16, rowData.IN_QTY16]);
      seriesDate.push([17, rowData.IN_QTY17]);
      seriesDate.push([18, rowData.IN_QTY18]);
      seriesDate.push([19, rowData.IN_QTY19]);
      seriesDate.push([20, rowData.IN_QTY20]);
      seriesDate.push([21, rowData.IN_QTY21]);
      seriesDate.push([22, rowData.IN_QTY22]);
      seriesDate.push([23, rowData.IN_QTY23]);
      seriesDate.push([24, rowData.IN_QTY24]);
      seriesDate.push([25, rowData.IN_QTY25]);
      seriesDate.push([26, rowData.IN_QTY26]);
      seriesDate.push([27, rowData.IN_QTY27]);
      seriesDate.push([28, rowData.IN_QTY28]);
      if (rowData.DAY_CNT >= 29) {
        seriesDate.push([29, rowData.IN_QTY29]);
      }
      if (rowData.DAY_CNT >= 30) {
        seriesDate.push([30, rowData.IN_QTY30]);
      }
      if (rowData.DAY_CNT == 31) {
        seriesDate.push([31, rowData.IN_QTY31]);
      }
      seriesDS.push(seriesDate);
    }
  }
...
function onGetMaster03(ajaxData) {
  ...
  if (rowCount === 0) {
    ...
    for (var row = 0; row < rowCount; row++) {
      ...
      seriesDate = new Array();
      seriesDate.push([rowData.QUARTER_DISP1, rowData.IN_QTY1]);
      seriesDate.push([rowData.QUARTER_DISP2, rowData.IN_QTY2]);
      seriesDate.push([rowData.QUARTER_DISP3, rowData.IN_QTY3]);
      seriesDate.push([rowData.QUARTER_DISP4, rowData.IN_QTY4]);
      seriesDS.push(seriesDate);
    }
  }
  window["G_CHTMASTER03"].replot({
...
function onGetMaster04(ajaxData) {
  ...
  if (rowCount === 0) {
    ...
    for (var row = 0; row < rowCount; row++) {
      ...
      seriesDate = new Array();
      seriesDate.push([rowData.MONTH_DISP1, rowData.IN_QTY1]);
      seriesDate.push([rowData.MONTH_DISP2, rowData.IN_QTY2]);
      seriesDate.push([rowData.MONTH_DISP3, rowData.IN_QTY3]);
      seriesDate.push([rowData.MONTH_DISP4, rowData.IN_QTY4]);
      seriesDate.push([rowData.MONTH_DISP5, rowData.IN_QTY5]);
      seriesDate.push([rowData.MONTH_DISP6, rowData.IN_QTY6]);
      seriesDate.push([rowData.MONTH_DISP7, rowData.IN_QTY7]);
      seriesDate.push([rowData.MONTH_DISP8, rowData.IN_QTY8]);
      seriesDate.push([rowData.MONTH_DISP9, rowData.IN_QTY9]);
      seriesDate.push([rowData.MONTH_DISP10, rowData.IN_QTY10]);
      seriesDate.push([rowData.MONTH_DISP11, rowData.IN_QTY11]);
      seriesDate.push([rowData.MONTH_DISP12, rowData.IN_QTY12]);
      seriesDS.push(seriesDate);
    }
  }
  window["G_CHTMASTER04"].replot({
