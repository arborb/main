(function($) {
  ...
  function CellRangeSelector(options) {
    ...
    function handleDrag(e, dd) {
      ...
      var end = _grid.getCellFromPoint(e.pageX - _$activeCanvas.offset().left + _columnOffset, e.pageY
          - _$activeCanvas.offset().top + _rowOffset);

      if ((!_grid.canCellBeSelected(end.row, end.cell)) || (!_isRightCanvas && (end.cell > _gridOptions.frozenColumn))
