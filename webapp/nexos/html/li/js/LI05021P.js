...
function _SetResizeOffset() {
  $NC.G_OFFSET.topHeight = 65;
  $NC.G_OFFSET.nonClientHeight = $("#divBottomView").outerHeight() + $NC.G_LAYOUT.topOffset + $NC.G_LAYOUT.margin2
      + $NC.G_OFFSET.topHeight;
}
...
function _OnResize(parent) {
  ...
  $NC.resizeContainer("#divMasterView", clientWidth, $NC.G_OFFSET.topHeight);
...
function _Save() {
  ...
  $NC.serviceCall("/LI05020E/save.do", {
