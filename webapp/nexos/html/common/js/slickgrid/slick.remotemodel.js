(function($) {
  /**
   * A sample AJAX data store implementation. Right now, it's hooked up to load all Apple-related Digg stories, but can
  ...
  function RemoteModel() {
    ...
    function ensureData(from, to) {
      ...
      var url = "http://api.thriftdb.com/api.hnsearch.com/items/_search?filter[fields][type][]=submission&q="
