...
/*jshint evil:true */
   ...
   * 
   * @type Object
   * @example // options can be changed before the script is included html5 = { 'elements': 'mark section', 'shivCSS':
  ...
  var html5 = {
    ...
    /**
     * A flag to indicate that the document's `createElement` and `createDocumentFragment` methods should be
     * overwritten.
     * 
     * @memberOf html5
     * @type Boolean
