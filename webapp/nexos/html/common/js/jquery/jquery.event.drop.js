/*
 * ! jquery.event.drop - v 2.2 Copyright (c) 2010 Three Dub Media - http://threedubmedia.com Open Source MIT License -
...
(function($) { // secure $ jQuery alias
  ...
  $.drop = function(opts) {
    ...
    drop.multi = opts.multi === true ? Infinity : opts.multi === false ? 1 : !isNaN(opts.multi) ? opts.multi
        : drop.multi;
  ...
  drop = $.event.special.drop = {
    ...
    locate: function(elem, index) {
      var data = $.data(elem, drop.datakey), $elem = $(elem), posi = $elem.offset() || {}, height = $elem.outerHeight(), width = $elem
          .outerWidth(), location = {
        elem: elem,
        width: width,
        height: height,
