...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/CS04020E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
  ...
  // 데이터 조회
  $NC.serviceCall("/CS04020E/getDataSet.do", $NC.getGridParams(G_GRDSUB), onGetSub);
}
...
function _Save() {
  ...
  if (saveDS.length > 0) {
    $NC.serviceCall("/CS04020E/save.do", {
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/CS04020E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL), onGetDetail);
