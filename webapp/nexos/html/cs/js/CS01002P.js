...
function _OnPopupOpen() {
  ...
  G_GRDSUBE.queryParams = $NC.getParams({
    P_WRITE_NO: $NC.G_VAR.userData.P_WRITE_NO,
    P_NOTICE_DIV: $NC.G_VAR.userData.P_NOTICE_DIV,
...
function _Save() {
  ...
  $NC.serviceCall("/CS01000E/callDelete.do", {
  ...
  $NC.serviceCall("/CS01000E/save1.do", {
