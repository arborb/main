  ...
  var options = {
    ...
    summaryRow: {
      ...
      compareFn: function(field, rowData) {
        ...
        if (field != "QTY_IN_BOX" && rowData.DATA_GRP != "1") {
          return false;
        }
        return true;
      }
...
function onGridMasterDblClick(e, args) {
  ...
  var Inout_Date = rowData.INOUT_DATE;
  if ($NC.isNull(Inout_Date) || Inout_Date === "" || Inout_Date == "[상품별합계]") {
...
function onChangingCondition() {
  ...
  // 기간별 수불내역
  $NC.setInitGridVar(G_GRDT3MASTER);
  $NC.setInitGridData(G_GRDT3MASTER);
  $NC.setGridDisplayRows("#grdT3Master", 0, 0);
