...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
}
...
function onBtnRecvClick(e) {
  ...
  if (DATA_DIV !== "01") {
    $NC.G_MAIN.uploadFileSelect(function(view, fileName) {
      ...
      $NC.G_MAIN.fileUpload("/ED03030E/recvFile.do", {
    ...
    $NC.serviceCall("/ED03030E/recvDBLink.do", {
      P_QUERY_ID: "ER_PROCESSING",
      P_QUERY_PARAMS: $NC.getParams({
        P_BU_CD: BU_CD,
        P_EDI_DIV: "RCM30",
...
function onBtnErrorProcAndColseClick(e) {
  ...
  // ER_PROCESSING 호출
  $NC.serviceCall("/ED03030E/callERProcessing.do", {
    P_QUERY_ID: "ER_PROCESSING",
    P_QUERY_PARAMS: $NC.getParams({
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED03030E/getDataSet.do", {
    P_QUERY_ID: "ED03030E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
