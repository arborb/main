...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED09030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED09030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);
...
function grdDetail1OnGetColumns() {
  ...
  $NC.setGridColumn(columns, {
    id: "ORDER_STATUS_DATETIME",
    field: "ORDER_STATUS_DATETIME",
    name: "주문상태변경일시",
    minWidth: 160,
    cssClass: "align-center",
  });
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED09030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
}
...
function onBtnSendClick(e) {
  ...
  var PROCESS_CD = "A";
  // ES_PROCESSING 호출
  $NC.serviceCall("/ED09030E/callESProcessing.do", {
...
function onBtnDownloadFileClick(e) {
  ...
  $NC.G_MAIN.fileDownload("/ED09030E/sendFileDownload.do", {
    P_QUERY_ID: "ED09030E.RS_DETAIL",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: rowData.CENTER_CD,
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED09030E/getDataSet.do", {
    P_QUERY_ID: "ED09030E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
