...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED06030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED06030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);
  ...
  var options = {
    ...
    specialRow: {
      compareFn: function(specialRow, rowData) {
        if (rowData.ERROR_DIV != "4" && rowData.ERROR_DIV != "9") {
          return "specialrow3";
        } 
      }
    }
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED06030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
...
function onBtnRecvClick(e) {
  ...
  if (DATA_DIV !== "01") {
    $NC.G_MAIN.uploadFileSelect(function(view, fileName) {
      ...
      $NC.G_MAIN.fileUpload("/ED06030E/recvFile.do", {
    ...
    $NC.serviceCall("/ED06030E/recvDBLink.do", {
      P_QUERY_ID: "ER_PROCESSING",
      P_QUERY_PARAMS: $NC.getParams({
        P_BU_CD: BU_CD,
        P_EDI_DIV: "RLO20",
...
function onBtnErrorProcAndColseClick(e) {
  ...
  // ER_PROCESSING 호출
  $NC.serviceCall("/ED06030E/callERProcessing.do", {
    P_QUERY_ID: "ER_PROCESSING",
    P_QUERY_PARAMS: $NC.getParams({
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED06030E/getDataSet.do", {
    P_QUERY_ID: "ED06030E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
