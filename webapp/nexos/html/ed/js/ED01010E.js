...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED01010E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function _Save() {
  ...
  if (saveDetailDS.length > 0) {
    $NC.serviceCall("/ED01010E/save.do", {
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED01010E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL), onGetDetail);
}
