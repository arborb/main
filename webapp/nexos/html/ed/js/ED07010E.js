...
function _OnResize(parent) {
  ...
  var splitBottomAreaHeight = clientHeight - splitTopAreaHeight - 9;// $("#grdDetail1").parent().parent().height() - 1;
...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED07010E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED07010E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);
...
function grdDetail1OnGetColumns() {
  ...
  $NC.setGridColumn(columns, {
    id: "MISCOLLECT_DIV",
    field: "MISCOLLECT_DIV",
    name: "미집배사유",
    minWidth: 90
  });
  $NC.setGridColumn(columns, {
    id: "MISCOLLECT_COMMENT",
    field: "MISCOLLECT_COMMENT",
    name: "미집배사유내역",
    minWidth: 120
  });
  $NC.setGridColumn(columns, {
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED07010E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
}
...
function onBtnRecvClick(e) {
  ...
  if (DATA_DIV !== "01") {
    $NC.G_MAIN.uploadFileSelect(function(view, fileName) {
      ...
      $NC.G_MAIN.fileUpload("/ED07010E/recvFile.do", {
    ...
    $NC.serviceCall("/ED07010E/recvDBLink.do", {
      P_QUERY_ID: "ER_PROCESSING",
      P_QUERY_PARAMS: $NC.getParams({
        P_BU_CD: BU_CD,
        P_EDI_DIV: "RWB10",
...
function onBtnErrorProcAndColseClick(e) {
  ...
  // ER_PROCESSING 호출
  $NC.serviceCall("/ED07010E/callERProcessing.do", {
    P_QUERY_ID: "ER_PROCESSING",
    P_QUERY_PARAMS: $NC.getParams({
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED07010E/getDataSet.do", {
    P_QUERY_ID: "ED07010E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
