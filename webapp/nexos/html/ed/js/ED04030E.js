...
function _OnInputChange(e, view, val) {
  ...
  switch (id) {
  case "INOUT_DATE":
    $NC.setValueDatePicker(view, val, "송신 반입일자를 정확히 입력하십시오.");
    break;
  }
}
...
function _Inquiry() {
  ...
  // 데이터 조회 - 미송신건수
  $NC.serviceCall("/ED04030E/getDataSet.do", {
    P_QUERY_ID: "ED04030E.RS_SUB3",
    P_QUERY_PARAMS: $NC.getParams({
  ...
  // 데이터 조회
  $NC.serviceCall("/ED04030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED04030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);
...
function grdDetail1OnGetColumns() {
  ...
  $NC.setGridColumn(columns, {
    id: "SEND_INBOUND_DATE",
    field: "SEND_INBOUND_DATE",
    name: "송신반입일자",
    cssClass: "align-center",
    minWidth: 120
  });
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED04030E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
}
...
function onBtnSendClick(e) {
  ...
  var PROCESS_CD = "A";
  // ES_PROCESSING 호출
  $NC.serviceCall("/ED04030E/callESProcessing.do", {
...
function onBtnDownloadFileClick(e) {
  ...
  $NC.G_MAIN.fileDownload("/ED04030E/sendFileDownload.do", {
    P_QUERY_ID: "ED04030E.RS_DETAIL",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: rowData.CENTER_CD,
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED04030E/getDataSet.do", {
    P_QUERY_ID: "ED04030E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
