...
function _Initialize() {
  ...
  $NC.setValue("#dtpQRecv_Date1", $NC.addDay($NC.getValue("#dtpQRecv_Date2"), -7));
...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03050E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function _Delete() {
  ...
  if (result) {
    ...
    // ER_PROCESSING 호출
    $NC.serviceCall("/ED03050E/callDelete.do", {
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03050E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL1), onGetDetail1);

  // 데이터 조회
  $NC.serviceCall("/ED03050E/getDataSet.do", {
    P_QUERY_ID: "ED03050E.RS_TOTAL",
    P_QUERY_PARAMS: $NC.getParams({
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: "RLO10",
      P_DEFINE_NO: rowData.DEFINE_NO,
...
function grdDetail1OnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/ED03050E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL2), onGetDetail2);
...
function onBtnRecvClick(e) {
  ...
  if (DATA_DIV !== "01") {
    $NC.G_MAIN.uploadFileSelect(function(view, fileName) {
      ...
      $NC.G_MAIN.fileUpload("/ED03050E/recvFile.do", {
    ...
    $NC.serviceCall("/ED03050E/recvDBLink.do", {
      P_QUERY_ID: "ER_PROCESSING",
      P_QUERY_PARAMS: $NC.getParams({
        P_BU_CD: BU_CD,
        P_EDI_DIV: "RLO10",
...
function onBtnErrorProcAndColseClick(e) {
  ...
  // ER_PROCESSING 호출
  $NC.serviceCall("/ED03050E/callERProcessing.do", {
    P_QUERY_ID: "ER_PROCESSING",
    P_QUERY_PARAMS: $NC.getParams({
      P_BU_CD: rowData.BU_CD,
      P_EDI_DIV: rowData.EDI_DIV,
...
//    onSuccess = onGetRecvError;
  ...
  // ER_PROCESSING 호출
  $NC.serviceCall("/ED03050E/callERProcessingClose.do", {
    P_QUERY_ID: "ER_PROCESSING",
...
function onGetDefineNo() {
  ...
  $NC.setInitCombo("/ED03050E/getDataSet.do", {
    P_QUERY_ID: "ED03050E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
