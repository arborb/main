...
function _Initialize() {
  ...
  $("#btnSub3").click(OnBtnSub3Click); // 송신항목 전체추가 버튼
...
function _OnPopupOpen() {
  ...
  $NC.setInitCombo("/WC/getDataSet.do", {
    ...
    onComplete: function() {
      ...
      // 입고/출고/반입/반출/기타입출고 확정 시만 추가 조회조건 사용
      switch ($NC.G_VAR.masterData.EDI_DIV) {
      case "SLI10":
      case "SLO10":
      case "SRI10":
      case "SRO10":
