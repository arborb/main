...
function _Inquiry() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    // 데이터 조회
    $NC.serviceCall("/LC08010E/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetMasterT1);
    ...
    // 데이터 조회
    $NC.serviceCall("/LC08010E/getDataSet.do", $NC.getGridParams(G_GRDT2MASTER), onGetMasterT2);
  }
}
...
function _New() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    $NC.G_MAIN.showProgramSubPopup({
      PROGRAM_ID: "LC08011P",
      PROGRAM_NM: "부자재입출고 등록",
      url: "lc/LC08011P.html",
      width: 1024,
      height: 600,
      userData: {
        P_PROCESS_CD: "N",
...
function _Delete() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    if (result) {
      $NC.serviceCall("/LC08010E/callLCProcessing.do", {
        P_PROCESS_DIV: "DEL",
        P_QUERY_PARAMS: $NC.getParams({
...
function grdT1MasterOnDblClick(e, args) {
  ...
  $NC.serviceCall("/LC08010E/getConfirmYn.do", {
    P_QUERY_PARAMS: $NC.getParams({
    ...
    if (masterRowData) {
      ...
      $NC.serviceCall("/LC08010E/getDataSet.do", {
        P_QUERY_ID: "LC08010E.RS_POP_SUB2",
        P_QUERY_PARAMS: $NC.getParams({
          P_CENTER_CD: masterRowData.CENTER_CD,
          P_BU_CD: masterRowData.BU_CD,
          P_ETC_DATE: masterRowData.ETC_DATE,
...
function grdT1MasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LC08010E/getDataSet.do", $NC.getGridParams(G_GRDT1DETAIL), onGetDetailT1);
