...
function _Inquiry() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    $NC.serviceCall("/LC04020E/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetMasterT1);
    ...
    // 데이터 조회
    $NC.serviceCall("/LC04020E/getDataSet.do", $NC.getGridParams(G_GRDT2MASTER), onGetMasterT2);
    ...
    // 데이터 조회
    $NC.serviceCall("/LC04020E/getDataSet.do", $NC.getGridParams(G_GRDT3MASTER), onGetMasterT3);
...
function _Delete() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    if (result) {
      $NC.serviceCall("/LC04020E/delete.do", {
...
function grdT1MasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LC04020E/getDataSet.do", $NC.getGridParams(G_GRDT1DETAIL), onGetDetailT1);
}
...
function onProcessPre() {
  ...
  $NC.serviceCall("/LC04020E/callLcInvestConfirmBWFW.do", {
...
function setPolicyValInfo() {
  ...
  for ( var POLICY_CD in $NC.G_VAR.policyVal) {
    // 데이터 조회
    $NC.serviceCall("/LC04020E/callSP.do", {
