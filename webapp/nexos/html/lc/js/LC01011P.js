...
function _OnPopupOpen() {
  ...
  $NC.setInitCombo("/WC/getDataSet.do", {
    ...
    onComplete: function() {
      ...
      var inoutCombo = document.getElementById('cboInout_Cd');
      for (var i = 0; i < inoutCombo.length;  i++) {
        if (inoutCombo.options[i].value == "E91") {
          inoutCombo.remove(i);
        }
      }
    }
...
function _Inquiry() {
  ...
  */
  ...
  $NC.serviceCall("/LC01010E/getDataSet.do", {
    P_QUERY_ID: "LC01010E.RS_POP_SUB1",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: $NC.G_VAR.userData.P_CENTER_CD,
...
function _Save() {
  ...
  $NC.serviceCall("/LC01010E/save.do", {
...
function setPolicyValInfo() {
  ...
  for ( var POLICY_CD in $NC.G_VAR.policyVal) {
    // 데이터 조회
    $NC.serviceCallAndWait("/LC01010E/callSP.do", {
