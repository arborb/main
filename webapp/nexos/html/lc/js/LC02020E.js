...
function _Inquiry() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    // 데이터 조회
    $NC.serviceCall("/LC02020E/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetMasterT1);
    ...
    // 데이터 조회
    $NC.serviceCall("/LC02020E/getDataSet.do", $NC.getGridParams(G_GRDT2MASTER), onGetMasterT2);
  }
}
...
function _Delete() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    if (result) {
      $NC.serviceCall("/LC02020E/callLCProcessing.do", {
        P_PROCESS_DIV: "DEL",
        P_QUERY_PARAMS: $NC.getParams({
...
function grdT1MasterOnDblClick(e, args) {
  ...
  $NC.serviceCall("/LC02020E/getConfirmYn.do", {
    P_QUERY_PARAMS: $NC.getParams({
    ...
    if (masterRowData) {
      ...
      $NC.serviceCall("/LC02020E/getDataSet.do", {
        P_QUERY_ID: "LC02020E.RS_POP_SUB2",
        P_QUERY_PARAMS: $NC.getParams({
          P_CENTER_CD: masterRowData.CENTER_CD,
          P_BU_CD: masterRowData.BU_CD,
          P_ETC_DATE: masterRowData.ETC_DATE,
...
function grdT1MasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LC02020E/getDataSet.do", $NC.getGridParams(G_GRDT1DETAIL), onGetDetailT1);
