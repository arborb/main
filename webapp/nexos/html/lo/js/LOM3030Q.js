...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LOM3030Q/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
  ...
  var options = {
    ...
    summaryRow: {
      ...
      resultFn: function(field, summary) {
        if (field == "QTY_RATE") {
          var result = Number((summary.CONFIRM_QTY / summary.ORDER_QTY * 100).toFixed(2));
