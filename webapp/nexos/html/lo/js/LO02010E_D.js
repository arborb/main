...
function grdMasterDOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LO02010E/getDataSet.do", $NC.getGridParams(G_GRDDETAILD), onGetDetailD);
  ...
  // 데이터 조회
  $NC.serviceCall("/LO02010E/getDataSet.do", $NC.getGridParams(G_GRDSUBD), onGetSubD);
