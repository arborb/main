...
function _Inquiry() {
  ...
  var PICK_SEQ      = $NC.G_VAR.userData.P_PICK_SEQ;
  var PICK_BOX_NO   = $NC.G_VAR.userData.P_PICK_BOX_NO;
  var ISLABELSCAN   = $NC.G_VAR.userData.P_ISLABELSCAN;
  ...
  if(ISLABELSCAN == "1"){
    ...
    G_GRDMASTERT1.queryParams = queryParams1;
  }
  ...
  if(ISLABELSCAN == "1"){
    ...
    G_GRDDETAILT1.queryParams = queryParams1;
  }
  // 데이터 조회
  $NC.serviceCall("/LOM7210E/getDataSet.do", 
...
function _Save() {
  ...
  $NC.serviceCall("/LOM7210E/save.do", {
...
function grdMasterT1Initialize() {
  ...
  $NC.setInitGridObject("#grdMasterT1", {
    ...
    queryId: ISLABELSCAN == "1"?"LOM7210E.RS_POP_MASTER":"LOM7210E.RS_POP_MASTER1",
    sortCol: "BOX_NO",
    gridOptions: options
  });
...
function grdDetailT1Initialize() {
  ...
  $NC.setInitGridObject("#grdDetailT1", {
    ...
    queryId: ISLABELSCAN == "1"?"LOM7210E.RS_POP_DETAIL":"LOM7210E.RS_POP_DETAIL1",
    sortCol: "ITEM_CD",
    gridOptions: options,
  });
...
function onBtnBoxDelete() {
  ...
  $NC.serviceCall("/LOM7210E/callScanBoxDelete.do", {
...
function onBtnBoxMerge() {
  ...
  $NC.serviceCall("/LOM7210E/callScanBoxMerge.do", {
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: CENTER_CD,
      P_BU_CD: BU_CD,
      P_OUTBOUND_DATE: OUTBOUND_DATE,
