...
function saveEntryBT() {
  ...
  if (saveDS.length > 0) {
    $NC.serviceCallAndWait("/LO02010E/saveEntryBT.do", {
...
function grdMasterBTInitialize() {
  ...
  $NC.setInitGridObject("#grdMasterBT", {
    ...
    queryId: "LO02010E.RS_T1B_MASTER",
    sortCol: "ITEM_CD",
    gridOptions: options,
...
function grdMasterBTOnAfterScroll(e, args) {
  ...
  if ($NC.isNull(rowData)) {
    ...
    G_GRDDETAILBT.queryParams = $NC.getParams({
      ...
      P_RDELIVERY_CD: masterParams.P_RDELIVERY_CD,
    ...
    // 데이터 조회
    $NC.serviceCall("/LO02010E/getDataSet.do", $NC.getGridParams(G_GRDDETAILBT), onGetDetailBT);
  }
...
function grdDetailBTInitialize() {
  ...
  $NC.setInitGridObject("#grdDetailBT", {
    ...
    queryId: "LO02010E.RS_T1B_DETAIL",
    sortCol: "ORDER_DATE",
    gridOptions: options
  });
