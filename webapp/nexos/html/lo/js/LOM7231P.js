...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LOM7230E/getDataSet.do", $NC.getGridParams(G_GRDMASTERT1), onGetMasterT1);
...
function _Save() {
  ...
  $NC.serviceCall("/LOM7230E/save.do", {
...
function onBtnBoxDelete() {
  ...
  $NC.serviceCall("/LOM7230E/callScanBoxDelete.do", {
...
function onBtnBoxMerge() {
  ...
  $NC.serviceCall("/LOM7230E/callScanBoxMerge.do", {
