...
function _Inquiry() {
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    // 데이터 조회
    $NC.serviceCall("/LO05020E/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetT1Master);
    ...
    // 데이터 조회
    $NC.serviceCall("/LO05020E/getDataSet.do", $NC.getGridParams(G_GRDT2MASTER), onGetT2Master);
  }
}
...
function grdT1DetailOnDblClick(e, args) {
  ...
  if (rowData) {
    $NC.G_MAIN.showProgramSubPopup({
      PROGRAM_ID: "LO05021P",
      PROGRAM_NM: "출고중량등록/수정",
      url: "lo/LO05021P.html",
      width: 650,
      height: 450,
      userData: {
...
function popUpOnOk() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LO05020E/getDataSet.do", $NC.getGridParams(G_GRDT1SUB), onGetT1Sub);
}
...
function grdT1MasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LO05020E/getDataSet.do", $NC.getGridParams(G_GRDT1DETAIL), onGetT1Detail);
...
function onSave(ajaxData) {
  ...
  _Inquiry();
  G_GRDT1MASTER.lastKeyVal = lastRowData.OUTBOUND_NO;
