...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LOM1020Q/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function _Print(printIndex, printName) {
  ...
  var BRAND_CD_F = BRAND_CD + " - " + $NC.getValue("#edtQBrand_Nm");
  var DELIVERY_CD = $NC.getValue("#edtQDelivery_Cd", true);
