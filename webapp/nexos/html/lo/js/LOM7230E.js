...
//    }
  ...
  $NC.serviceCallAndWait("/LOM7230E/callScanBoxSave.do", {
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: rowData.CENTER_CD,
      P_BU_CD: rowData.BU_CD,
      P_OUTBOUND_DATE: rowData.OUTBOUND_DATE,
  ...
  /*  
    $NC.serviceCallAndWait("/LOM7230E/save.do", {
...
function _Cancel() {
  ...
  setTimeout(function() {
    ...
    var rd = G_GRDMASTER.data.getItem(G_GRDMASTER.lastRow);
    if (rd.REMAIN_QTY == '0') {
      rd.INSPECT_YN = 'Y';
...
function onBtnFWScanConfirm(e) {
  ...
  */
  ...
  $NC.serviceCall("/LOM7230E/callFWScanConfirm.do", {
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: CENTER_CD,
      P_BU_CD: BU_CD,
      P_OUTBOUND_DATE: OUTBOUND_DATE,
  ...
  */
  ...
  showMessage({
    ...
    onYesFn: function() {
      ...
      $NC.serviceCallAndWait("/LOM7230E/callBWScanConfirm.do", {
        P_QUERY_PARAMS: $NC.getParams({
          P_CENTER_CD: rowData.CENTER_CD,
          P_BU_CD: rowData.BU_CD,
          P_OUTBOUND_DATE: rowData.OUTBOUND_DATE,
      ...
      // 데이터 조회
      /*
            $NC.serviceCall("/LOM7230E/callBWScanConfirm.do", {
              P_QUERY_PARAMS: $NC.getParams({
                P_CENTER_CD: CENTER_CD,
                P_BU_CD: BU_CD,
                P_OUTBOUND_DATE: OUTBOUND_DATE,
...
//    setEnableButton("#btnBoxCancel", false);
    ...
    if (rowData.HAS_DIV == '1') {
      var msg = '합포장대상(' + rowData.FLOOR_DIV + '층)\n' + rowData.LOCATION_CD;
      $NC.setValue("#edtBox_No", msg);
      $('#edtBox_No').addClass('inspected');
      doPrint4();
    }
...
function onFWScanConfirm(ajaxData) {
  ...
  $NC.serviceCallAndWait("/LOM7010E/callSP.do", {
    P_QUERY_ID: "LOM7230E.GET_INQUERY_YN",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: CENTER_CD,
      P_BU_CD: BU_CD,
      P_OUTBOUND_DATE: OUTBOUND_DATE,
...
function setUpdateOrderCan(center_Cd, bu_Cd, outbound_Date, outbound_No, item_Cd) {
  ...
  $NC.serviceCallAndWait("/LOM7230E/callSP.do", {
...
function onScanItem(scanVal) {
  ...
  */
  // 데이터 조회
  $NC.serviceCallAndWait("/LOM7230E/callSP.do", {
    P_QUERY_ID: "LOM7230E.GET_ITEM_INFO",
    P_QUERY_PARAMS: $NC.getParams({
      P_CENTER_CD: CENTER_CD,
      P_BU_CD: BU_CD,
      P_OUTBOUND_DATE: OUTBOUND_DATE,
...
function onScanItemCounting(scanVal, column_Nm, item_Cd) {
  ...
  */
  ...
  rowData.INSPECT_QTY = INSPECT_QTY + ITEM_QTY;
  rowData.REMAIN_QTY = ENTRY_QTY - CONFIRM_QTY - ITEM_QTY;
  rowData.CONFIRM_QTY = ENTRY_QTY - rowData.REMAIN_QTY;
...
function onBtnBoxCancelExec(e) {
  ...
  showMessage({
    ...
    onYesFn: function() {
      ...
      // 데이터 조회
      $NC.serviceCall("/LOM7230E/callSP.do", {
