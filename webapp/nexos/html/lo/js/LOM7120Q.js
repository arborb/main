...
function _Inquiry() {
  ...
  var OUTBOUND_DATE = $NC.getValue("#dtpQOutbound_Date", true);
  if(OUTBOUND_DATE==null || OUTBOUND_DATE==""){
    OUTBOUND_DATE = "";
  }
  ...
  // 데이터 조회
  $NC.serviceCall("/LOM7120Q/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
