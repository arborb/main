...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LO01010E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
...
function grdMasterOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/LO01010E/getDataSet.do", $NC.getGridParams(G_GRDDETAIL), onGetDetail);
