...
function _Inquiry() {
  ...
  case 0 :
    ...
    // 데이터 조회
    $NC.serviceCall("/LX03030Q/getDataSet.do", $NC.getGridParams(G_GRDT1MASTER), onGetT1Master);
    break;
  case 1 :
    ...
    // 데이터 조회
    $NC.serviceCall("/LX03030Q/getDataSet.do", $NC.getGridParams(G_GRDT2MASTER), onGetT2Master);
    break;
  case 2 :
    ...
    // 데이터 조회
    $NC.serviceCall("/LX03030Q/getDataSet.do", $NC.getGridParams(G_GRDT3MASTER), onGetT3Master);
    break;
  } 
}
