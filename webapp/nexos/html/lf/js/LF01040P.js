...
function _OnPopupOpen() {
  ...
  $NC.setValue("#edtQFee_Head_Cd", $NC.G_VAR.userData.P_FEE_HEAD_CD);
  $NC.setValue("#edtQFee_Base_Cd", $NC.G_VAR.userData.P_FEE_BASE_CD);
  ...
  // 데이터 조회
  $NC.serviceCall("/LF01030E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
