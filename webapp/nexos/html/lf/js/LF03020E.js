...
function _Initialize() {
  ...
  // 조회조건 - 정산항목 세팅
  $NC.setInitCombo("/LF03020E/getDataSet.do", {
    P_QUERY_ID: "LF03020E.RS_SUB1",
    P_QUERY_PARAMS: $NC.getParams("{}")
  }, {
...
function _Inquiry() {
  ...
  // 데이터 조회
  $NC.serviceCall("/LF03020E/getDataSet.do", $NC.getGridParams(G_GRDMASTER), onGetMaster);
}
...
function _Save() {
  ...
  if (saveMasterDS.length > 0) {
    $NC.serviceCall("/LF03020E/save.do", {
