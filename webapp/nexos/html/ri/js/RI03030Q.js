...
//  var BRAND_CD = $NC.getValue("#edtQBrand_Cd", true);
  ...
  if ($("#divMasterView").tabs("option", "active") === 0) {
    ...
    // 데이터 조회
    $NC.serviceCall("/RI03030Q/getDataSet.do", $NC.getGridParams(G_GRDMASTERT1), onGetMasterT1);
    ...
    // 데이터 조회
    $NC.serviceCall("/RI03030Q/getDataSet.do", $NC.getGridParams(G_GRDMASTERT2), onGetMasterT2);
...
function grdMasterT2Initialize() {
  ...
  var dataGroupOptions = {
    getter: function(rowData) {
      return $NC.lPad(rowData.DELIVERY_CD, 20) + "|" + $NC.lPad(rowData.RDELIVERY_CD, 20);
    },
