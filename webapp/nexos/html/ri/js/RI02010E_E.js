...
function grdMasterEOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/RI02010E/getDataSet.do", $NC.getGridParams(G_GRDDETAILE), onGetDetailE);
  ...
  // 데이터 조회
  $NC.serviceCall("/RI02010E/getDataSet.do", $NC.getGridParams(G_GRDSUBE), onGetSubE);
