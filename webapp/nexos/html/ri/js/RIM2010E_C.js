...
function onGetNewLocationIdC(ajaxData) {
  ...
  if (!$NC.isNull(resultData)) {
    if (resultData.O_MSG === "OK") {
      ...
      // 로케이션ID 조회
      $NC.serviceCall("/RIM2010E/getDataSet.do", {
        P_QUERY_ID: "RIM2010E.RS_T2_SUB1",
        P_QUERY_PARAMS: $NC.getParams({
          P_CENTER_CD: rowData.CENTER_CD,
          P_BU_CD: rowData.BU_CD,
          P_INBOUND_DATE: rowData.INBOUND_DATE,
...
function grdMasterCOnAfterScroll(e, args) {
  ...
  // 데이터 조회
  $NC.serviceCall("/RIM2010E/getDataSet.do", $NC.getGridParams(G_GRDDETAILC), onGetDetailC);
  ...
  // 데이터 조회
  $NC.serviceCall("/RIM2010E/getDataSet.do", $NC.getGridParams(G_GRDLOCATIONIDC), onGetLocationIdC);
  ...
  // 데이터 조회
  $NC.serviceCall("/RIM2010E/getDataSet.do", $NC.getGridParams(G_GRDSUBC), onGetSubC);
