...
/**
 * Class: ED04010EService<br>
 * Description: [송신]입고확정 관리(ED04010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED04010E")
public class ED04010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED04010EService.class);
