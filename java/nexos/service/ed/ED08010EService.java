...
/**
 * Class: ED08010EService<br>
 * Description: [송신]CJ대한통운 택배송장 관리(ED08010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED08010E")
public class ED08010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED08010EService.class);
