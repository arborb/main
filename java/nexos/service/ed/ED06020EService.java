...
/**
 * Class: ED06020EService<br>
 * Description: [수신]우편번호마스터(ED06020E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED06020E")
public class ED06020EService {

  // private final Logger logger = LoggerFactory.getLogger(ED06020EService.class);
