...
/**
 * Class: ED06010EService<br>
 * Description: [수신]안전재고마스터 관리(ED06010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED06010E")
public class ED06010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED06010EService.class);
