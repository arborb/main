...
/**
 * Class: ED04040EService<br>
 * Description: [송신]반출확정 관리(ED04040E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED04040E")
public class ED04040EService {

  // private final Logger logger = LoggerFactory.getLogger(ED04040EService.class);
