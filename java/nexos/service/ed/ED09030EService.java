...
/**
 * Class: ED09030EService<br>
 * Description: [송신]출고주문상태(ED09030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED09030E")
public class ED09030EService {

  // private final Logger logger = LoggerFactory.getLogger(ED09030EService.class);
