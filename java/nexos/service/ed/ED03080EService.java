...
/**
 * Class: ED03080EService<br>
 * Description: [수신]유통가공 관리(ED03080E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03080E")
public class ED03080EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03080EService.class);
