...
/**
 * Class: ED03120EService<br>
 * Description: [수신]주문리스트 출고예정 관리(ED03120E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03120E")
public class ED03120EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03120EService.class);

  /**
   * DAO 주입처리하기
   */
  @Resource
  private ED03120EDAO                dao;
    ...
    if (DATA_DIV_DBLINK.equals(data_Div)) {
      ...
      try {
        if (DATA_DIV_EXCEL.equals(data_Div)) {
          mapResult = edCommon.recvExcel_01(params);
