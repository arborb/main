...
/**
 * Class: ED03040EService<br>
 * Description: [수신]입고예정 관리(ED03040E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03040E")
public class ED03040EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03040EService.class);
