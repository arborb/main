...
/**
 * Class: ED06030EService<br>
 * Description: [수신]출고주문상태 관리(ED06030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED06030E")
public class ED06030EService {

  // private final Logger logger = LoggerFactory.getLogger(ED06030EService.class);
