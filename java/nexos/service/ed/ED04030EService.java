...
/**
 * Class: ED04030EService<br>
 * Description: [송신]반입확정 관리(ED04030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED04030E")
public class ED04030EService {

  // private final Logger logger = LoggerFactory.getLogger(ED04030EService.class);
