...
/**
 * Class: ED04020EService<br>
 * Description: [송신]출고확정 관리(ED04020E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED04020E")
public class ED04020EService {

  // private final Logger logger = LoggerFactory.getLogger(ED04020EService.class);
