 ...
 * Description: [송신]변동가용재고(ED09020E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED09010E")
public class ED09010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED09010EService.class);
