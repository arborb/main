...
/**
 * Class: ED03010EService<br>
 * Description: [수신]상품마스터 관리(ED03010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03010E")
public class ED03010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03010EService.class);
