...
/**
 * Class: ED09060EService<br>
 * Description: [송신]변동가용재고(ED09060E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED09060E")
public class ED09060EService {

  // private final Logger logger = LoggerFactory.getLogger(ED09060EService.class);
