...
/**
 * Class: ED03070EService<br>
 * Description: [수신]반출예정 관리(ED03070E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03070E")
public class ED03070EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03070EService.class);
