...
/**
 * Class: ED03110EService<br>
 * Description: [수신]공급처마스터 관리(ED03110E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03110E")
public class ED03110EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03110EService.class);
