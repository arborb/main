...
/**
 * Class: ED09040EService<br>
 * Description: [송신]브랜드별가용재고(ED09040E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED09040E")
public class ED09040EService {

  private final Logger               logger = LoggerFactory.getLogger(ED09040EService.class);
