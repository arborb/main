...
public class SoldToParty implements java.io.Serializable {
  private java.lang.String                                id;

  private java.lang.String                                customerPartyId;

  private nexos.service.ed.ws.elca.corpOnLineEcom.Address address;

  public SoldToParty() {
  }

  public SoldToParty(java.lang.String id, java.lang.String customerPartyId,
    nexos.service.ed.ws.elca.corpOnLineEcom.Address address) {
    this.id = id;
  ...
  /**
   * Gets the id value for this SoldToParty.
   * 
   * @return id
   */
  ...
  /**
   * Sets the id value for this SoldToParty.
   * 
   * @param id
   */
  ...
  /**
   * Gets the customerPartyId value for this SoldToParty.
   * 
  ...
  /**
   * Sets the customerPartyId value for this SoldToParty.
   * 
  ...
  /**
   * Gets the address value for this SoldToParty.
   * 
   * @return address
   */
  public nexos.service.ed.ws.elca.corpOnLineEcom.Address getAddress() {
    return address;
  }

  /**
   * Sets the address value for this SoldToParty.
   * 
   * @param address
   */
  public void setAddress(nexos.service.ed.ws.elca.corpOnLineEcom.Address address) {
    this.address = address;
  }
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof SoldToParty))
      return false;
    SoldToParty other = (SoldToParty)obj;
    if (obj == null)
      return false;
    if (this == obj)
      return true;
