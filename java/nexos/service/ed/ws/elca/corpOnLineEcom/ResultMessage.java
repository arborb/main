...
public class ResultMessage implements java.io.Serializable {
  ...
  private nexos.service.ed.ws.elca.corpOnLineEcom.MessageType messageType;
  ...
  public ResultMessage(java.lang.String messageCode, nexos.service.ed.ws.elca.corpOnLineEcom.MessageType messageType,
  ...
  /**
   * Gets the messageCode value for this ResultMessage.
   * 
   * @return messageCode
   */
  ...
  /**
   * Sets the messageCode value for this ResultMessage.
   * 
   * @param messageCode
   */
  ...
  /**
   * Gets the messageType value for this ResultMessage.
   * 
   * @return messageType
   */
  public nexos.service.ed.ws.elca.corpOnLineEcom.MessageType getMessageType() {
    return messageType;
  }

  /**
   * Sets the messageType value for this ResultMessage.
   * 
   * @param messageType
   */
  public void setMessageType(nexos.service.ed.ws.elca.corpOnLineEcom.MessageType messageType) {
    this.messageType = messageType;
  }

  /**
   * Gets the messageDescription value for this ResultMessage.
   * 
  ...
  /**
   * Sets the messageDescription value for this ResultMessage.
   * 
