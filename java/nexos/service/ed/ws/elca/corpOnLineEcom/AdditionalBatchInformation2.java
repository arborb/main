/**
 * AdditionalBatchInformation2.java
...
public class AdditionalBatchInformation2 implements java.io.Serializable {
  private java.lang.String                                         fileFormatIndicator;

  private java.lang.String                                         batchFileName;

  private nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2[] controlAmount;
  ...
  public AdditionalBatchInformation2() {
  }

  public AdditionalBatchInformation2(java.lang.String fileFormatIndicator, java.lang.String batchFileName,
    nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2[] controlAmount, java.lang.String checkSumName,
  ...
  /**
   * Gets the fileFormatIndicator value for this AdditionalBatchInformation2.
   * 
  ...
  /**
   * Sets the fileFormatIndicator value for this AdditionalBatchInformation2.
   * 
  ...
  /**
   * Gets the batchFileName value for this AdditionalBatchInformation2.
   * 
  ...
  /**
   * Sets the batchFileName value for this AdditionalBatchInformation2.
   * 
   * @param batchFileName
   */
  ...
  /**
   * Gets the controlAmount value for this AdditionalBatchInformation2.
   * 
   * @return controlAmount
   */
  public nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2[] getControlAmount() {
    return controlAmount;
  }

  /**
   * Sets the controlAmount value for this AdditionalBatchInformation2.
   * 
   * @param controlAmount
   */
  public void setControlAmount(nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2[] controlAmount) {
    this.controlAmount = controlAmount;
  }

  public nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2 getControlAmount(int i) {
    return this.controlAmount[i];
  }

  public void setControlAmount(int i, nexos.service.ed.ws.elca.corpOnLineEcom.ControlAmount2 _value) {
    this.controlAmount[i] = _value;
  }

  /**
   * Gets the checkSumName value for this AdditionalBatchInformation2.
   * 
   * @return checkSumName
   */
  ...
  /**
   * Sets the checkSumName value for this AdditionalBatchInformation2.
   * 
   * @param checkSumName
   */
  ...
  /**
   * Gets the checkSumValue value for this AdditionalBatchInformation2.
   * 
  ...
  /**
   * Sets the checkSumValue value for this AdditionalBatchInformation2.
   * 
   * @param checkSumValue
   */
  ...
  /**
   * Gets the batchStatus value for this AdditionalBatchInformation2.
   * 
   * @return batchStatus
   */
  ...
  /**
   * Sets the batchStatus value for this AdditionalBatchInformation2.
   * 
   * @param batchStatus
   */
  ...
  /**
   * Gets the batchResubmitCount value for this AdditionalBatchInformation2.
   * 
  ...
  /**
   * Sets the batchResubmitCount value for this AdditionalBatchInformation2.
   * 
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof AdditionalBatchInformation2))
      return false;
    AdditionalBatchInformation2 other = (AdditionalBatchInformation2)obj;
    if (obj == null)
      return false;
    if (this == obj)
      return true;
  ...
  private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
                                                                 AdditionalBatchInformation2.class, true);
