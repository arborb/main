...
public class TradingNetworks2 implements java.io.Serializable {
  ...
  public TradingNetworks2() {
  }

  public TradingNetworks2(java.lang.String senderId, java.lang.String senderQualifier, java.lang.String receiverId,
  ...
  /**
   * Gets the senderId value for this TradingNetworks2.
   * 
   * @return senderId
   */
  ...
  /**
   * Sets the senderId value for this TradingNetworks2.
   * 
   * @param senderId
   */
  ...
  /**
   * Gets the senderQualifier value for this TradingNetworks2.
   * 
  ...
  /**
   * Sets the senderQualifier value for this TradingNetworks2.
   * 
  ...
  /**
   * Gets the receiverId value for this TradingNetworks2.
   * 
   * @return receiverId
   */
  ...
  /**
   * Sets the receiverId value for this TradingNetworks2.
   * 
   * @param receiverId
   */
  ...
  /**
   * Gets the receiverQualifier value for this TradingNetworks2.
   * 
  ...
  /**
   * Sets the receiverQualifier value for this TradingNetworks2.
   * 
  ...
  /**
   * Gets the envelopeDateTime value for this TradingNetworks2.
   * 
  ...
  /**
   * Sets the envelopeDateTime value for this TradingNetworks2.
   * 
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof TradingNetworks2))
      return false;
    TradingNetworks2 other = (TradingNetworks2)obj;
    if (obj == null)
      return false;
    if (this == obj)
      return true;
