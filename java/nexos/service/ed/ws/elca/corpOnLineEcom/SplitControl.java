...
public class SplitControl implements java.io.Serializable {
  private nexos.service.ed.ws.elca.corpOnLineEcom.SplitFlag splitFlag;
  ...
  public SplitControl(nexos.service.ed.ws.elca.corpOnLineEcom.SplitFlag splitFlag, java.math.BigInteger sequence,
  ...
  /**
   * Gets the splitFlag value for this SplitControl.
   * 
   * @return splitFlag
   */
  public nexos.service.ed.ws.elca.corpOnLineEcom.SplitFlag getSplitFlag() {
    return splitFlag;
  }

  /**
   * Sets the splitFlag value for this SplitControl.
   * 
   * @param splitFlag
   */
  public void setSplitFlag(nexos.service.ed.ws.elca.corpOnLineEcom.SplitFlag splitFlag) {
    this.splitFlag = splitFlag;
  }

  /**
   * Gets the sequence value for this SplitControl.
   * 
   * @return sequence
   */
  ...
  /**
   * Sets the sequence value for this SplitControl.
   * 
   * @param sequence
   */
  ...
  /**
   * Gets the count value for this SplitControl.
   * 
   * @return count
   */
  ...
  /**
   * Sets the count value for this SplitControl.
   * 
   * @param count
   */
  ...
  public synchronized boolean equals(java.lang.Object obj) {
    if (!(obj instanceof SplitControl))
      return false;
    SplitControl other = (SplitControl)obj;
    if (obj == null)
      return false;
    if (this == obj)
      return true;
