...
public class EDReceiverAxisImpl extends ServletEndpointSupport implements EDReceiverAxis {

  private final Logger      logger = LoggerFactory.getLogger(EDReceiverAxisImpl.class);
  ...
  protected void onInit() throws ServiceException {
    ...
    this.service = (EDReceiverService)getWebApplicationContext().getBean("EDRECEIVER");
    this.taskProps = (Properties)getWebApplicationContext().getBean("taskProps");
  }
  ...
  public String productDataExport(String xmlString) {
    ...
    logger.info("EDReceiver[ProductDataExport >> recvResult]  " + result);
  ...
  public String orderExport(String xmlString) {
    ...
    result = sbResult.toString();
    logger.info("EDReceiver[OrderExport >> recvResult]  " + result);
  ...
  public String orderStatus(String xmlString) {
    ...
    result = sbResult.toString();
    logger.info("EDReceiver[OrderStatus >> recvResult]  " + result);
