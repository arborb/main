...
/**
 * Class: ED07010EService<br>
 * Description: [수신]CJ대한통운 배송결과 관리(ED07010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED07010E")
public class ED07010EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03090EService.class);
