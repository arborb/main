...
/**
 * Class: ED03030EService<br>
 * Description: [수신]배송처마스터 관리(ED03030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED03030E")
public class ED03030EService {

  // private final Logger logger = LoggerFactory.getLogger(ED03030EService.class);
