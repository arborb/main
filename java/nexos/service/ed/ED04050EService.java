...
/**
 * Class: ED04050EService<br>
 * Description: [송신]기타입출고 관리(ED04050E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("ED04050E")
public class ED04050EService {

  // private final Logger logger = LoggerFactory.getLogger(ED04050EService.class);
