...
import nexos.service.lc.LC02030EDAO;
...
/**
 * Class: LC02030EService<br>
 * Description: 브랜드이관관리(LC02030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("LC02030E")
public class LC02030EService {

  /**
   * DAO 주입처리하기 
   */
  @Resource
  private LC02030EDAO                dao;
  ...
  public String save(Map<String, Object> params) throws Exception {
    ...
    if (!Consts.PROCESS_ENTRY_NEW.equals(process_Cd)) {
      ...
      checkParams.put("P_ETC_NO", masterDS.get("P_ETC_NO"));
