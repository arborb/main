...
/**
 * Class: LC02010EService<br>
 * Description: 상태변환관리(LC02010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
...
public class LC02010EService {
  ...
  public String save(Map<String, Object> params) throws Exception {
    ...
    checkParams.put("P_REMARK1", masterDS.get("P_REMARK1"));
