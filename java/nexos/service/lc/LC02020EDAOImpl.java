...
/**
 * Class: WCDAOImpl<br>
 * Description: LC02020E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("LC02020eDAO")
public class LC02020EDAOImpl implements LC02020EDAO {
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    final String PRORAM_ID = "LC02020E";
    ...
    if (subDS.size() > 0) {
      for (int i = 0; i < subDS.size(); i++) {
        ...
        if (Consts.DV_CRUD_C.equals(crud)) {
          ...
          HashMap<String, Object> mapResult = nexosDAO.callSP(LC_BW_ETC_ENTRY, spParams);
          String oMsg = (String)mapResult.get(Consts.PK_O_MSG);
          if (!Consts.OK.equals(oMsg)) {
            throw new RuntimeException(oMsg);
          }
