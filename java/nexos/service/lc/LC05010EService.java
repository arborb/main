...
/**
 * Class: LC05010EService<br>
 * Description: 재고속성 관리(LC05010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("LC05010E")
public class LC05010EService {

  // private final Logger logger = LoggerFactory.getLogger(LC05010EService.class);
  ...
  public String callPorpertiesUpdate(Map<String, Object> params) throws Exception {
    ...
    final String PROCEDURE_ID = "LS_010NM_PROPERTIES_UPDATE";
