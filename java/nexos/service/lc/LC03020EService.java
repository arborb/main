...
/**
 * Class: LC03020EService<br>
 * Description: 로케이션ID병합관리(LC03020E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("LC03020E")
public class LC03020EService {

  /**
   * DAO 주입처리하기
   */
  @Resource
  private LC03020EDAO                dao;
  ...
  public HashMap callLCBwLocIdMergeEntry(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "LC_BW_LOCID_MERGE_ENTRY";
   ...
   */
  @SuppressWarnings("rawtypes")
  public HashMap callLCLocIdMergeConfrim(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "LC_FW_LOCID_MERGE_CONFIRM";
    HashMap<String, Object> mapResult;
