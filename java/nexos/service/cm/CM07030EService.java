...
/**
 * Class: CM07030EService<br>
 * Description: 상품사업팀매칭 관리(CM07030E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("CM07030E")
public class CM07030EService {

  /**
   * DAO 주입처리하기
   */
  @Resource
  private CM07030EDAO                dao;
  ...
  public String callItemBuMatchOwnBrand(Map<String, Object> params) throws Exception {
    ...
    try {
      result = dao.callItemBuMatchOwnBrand(params);
      // 오류면 Rollback
