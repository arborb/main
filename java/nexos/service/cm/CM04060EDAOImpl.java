...
/**
 * Class: WCDAOImpl<br>
 * Description: CM04060E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("CM04060EDAO")
public class CM04060EDAOImpl implements CM04060EDAO {
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    final String PRORAM_ID = "CM04060E";
    final String TABLE_NM = "CMVENDORITEM";
  ...
  public String callVendorItemAddItem(Map<String, Object> params) throws Exception {
    ...
    final String CM_VENDORITEM_ITEM_ALLOCATE_ID = "CM_VENDORITEM_ITEM_ALLOCATE";
    ...
    mapResult = nexosDAO.callSP(CM_VENDORITEM_ITEM_ALLOCATE_ID, params);
