...
/**
 * Class: CM10010EDAOImpl<br>
 * Description: CM10010E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("CM10010EDAO")
public class CM10010EDAOImpl implements CM10010EDAO {
  ...
  public void delete(Map<String, Object> params) throws Exception {
    ...
    final String PRORAM_ID = "CM10010E";
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    final String CMDEAL_UPDATE_ID = PRORAM_ID + ".UPDATE_CMDEAL";
    //
    ...
    if (dsCnt > 0) {
      ...
      for (int i = 0; i < dsCnt; i++) {
        ...
        if (Consts.DV_CRUD_U.equals(crud)) {
          nexosDAO.update(CMDEAL_UPDATE_ID, rowData);
        }
        /*
         ...
         * newParams.put("P_EVENT_CD", masterDS.get("P_EVENT_CD"));
