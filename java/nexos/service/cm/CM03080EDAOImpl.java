...
/**
 * Class: WCDAOImpl<br>
 * Description: CM03080E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("CM03080EDAO")
public class CM03080EDAOImpl implements CM03080EDAO {
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    final String PRORAM_ID = "CM03080E";
    final String CM_OWNBRAND_CRE3_ID = "CM_OWNBRAND_CRE3";
    final String TABLE_NM = "CMOWNBRAND";
    ...
    for (int i = 0; i < dsCnt; i++) {
      ...
      if (Consts.DV_CRUD_C.equals(crud)) {
        ...
        newParams.put("P_OWN_BRAND_CD", rowData.get("P_OWN_BRAND_CD"));
        newParams.put("P_USER_ID", rowData.get("P_REG_USER_ID"));

        HashMap<String, Object> mapResult = nexosDAO.callSP(CM_OWNBRAND_CRE3_ID, newParams);
