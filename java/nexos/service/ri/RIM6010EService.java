...
/**
 * Class: RIM6010EService<br>
 * Description: 반입출고스캔검수(RIM6010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("RIM6010E")
public class RIM6010EService {

  /**
   * DAO 주입처리하기
   */
  @Resource
  private RIM6010EDAO                dao;
  ...
  public Map callFWScanUpdate(Map<String, Object> params) throws Exception {
    ...
    TransactionStatus ts = transactionManager.getTransaction(new DefaultTransactionDefinition());
    try {
      result = dao.callFWScanUpdate(params);
      String oMsg = (String)result.get(Consts.PK_O_MSG);
      // 오류면 Rollback
      if (!Consts.OK.equals(oMsg)) {
        throw new RuntimeException(oMsg);
