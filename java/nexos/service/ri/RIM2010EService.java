...
/**
 * Class: RIM2010EService<br>
 * Description: 온라인반입작업(RIM2010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("RIM2010E")
public class RIM2010EService {

  // private final Logger logger = LoggerFactory.getLogger(RIM2010EService.class);

  /**
   * DAO 주입처리하기
   */
  @Resource
  private RIM2010EDAO                dao;
  ...
  public String callRIEntryProcessing(Map<String, Object> params) throws Exception {
    ...
    final String PROCEDURE_ID = "RI_FW_ENTRY_PROCESSING";
   ...
   */
  @SuppressWarnings("unchecked")
  public String callRIOrderSp(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "ES_RIORDER_FROM_REAL_TYPE2";
  ...
  public String callRIProcessing(Map<String, Object> params) throws Exception {
    ...
    final String PROCEDURE_ID = "RI_PROCESSING";
    ...
    for (int i = 0; i < dsCnt; i++) {
      ...
      callParams.put("P_DIRECTION", direction);
      callParams.put(Consts.PK_USER_ID, user_Id);
      String inbound_No = (String)callParams.get("P_INBOUND_NO");

      // 진행상태 체크
      checkParams.put("P_CENTER_CD", callParams.get("P_CENTER_CD"));
      checkParams.put("P_BU_CD", callParams.get("P_BU_CD"));
      checkParams.put("P_INBOUND_DATE", callParams.get("P_INBOUND_DATE"));
      checkParams.put("P_INBOUND_NO", inbound_No);
