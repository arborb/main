...
/**
 * Class: RI02010EService<br>
 * Description: 반입작업(RI02010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("RI02010E")
public class RI02010EService {

  // private final Logger logger = LoggerFactory.getLogger(RI02010EService.class);

  /**
   * DAO 주입처리하기 
   */
  @Resource
  private RI02010EDAO                dao;
