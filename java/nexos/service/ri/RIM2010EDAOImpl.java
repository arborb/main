...
/**
 * Class: RIM2010EDAOImpl<br>
 * Description: RIM2010E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("RIM2010EDAO")
public class RIM2010EDAOImpl implements RIM2010EDAO {

  // private final Logger logger = LoggerFactory.getLogger(RIM2010EDAOImpl.class);
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    // SQLMAP ID 세팅
    final String PRORAM_ID = "RIM2010E";
    ...
    // 온라인반입예정테이블
    //final String SUB_TABLE_NM = "RI020PM";
    //final String SUB_INSERT_ID = PRORAM_ID + ".INSERT_" + SUB_TABLE_NM;
   // final String SUB_UPDATE_ID = PRORAM_ID + ".UPDATE_" + SUB_TABLE_NM;


    final String RIM_INSERT_ID1 = "RIM_2010PM_INSERT";
    final String RIM_UPDATE_ID1 = "RIM_2010PM_UPDATE";

    
    final String RIM20NM_GETNO_ID = "WT.RI_020NM_GETNO";
    final String RIM20ND_GETNO_ID = "WT.RI_020ND_GETNO";
    ...
    if (Consts.PROCESS_ORDER.equals(process_Cd) || Consts.PROCESS_ENTRY_NEW.equals(process_Cd)) {
      ...
      if (dsCnt < 1) {
        throw new RuntimeException("온라인반입등록 상세내역이 존재하지 않습니다.");
      }
      ...
      HashMap<String, Object> mapResult = nexosDAO.callSP(RIM20NM_GETNO_ID, newParams);
      ...
      subDS.put("P_INBOUND_NO", inbound_No);
      ...
      HashMap<String, Object> mapResult = nexosDAO.callSP(RIM20ND_GETNO_ID, newParams);
      String oMsg = (String)mapResult.get(Consts.PK_O_MSG);
      if (!Consts.OK.equals(oMsg)) {
        throw new RuntimeException(oMsg);
      }
  ...
  public void saveDirections(Map<String, Object> params) throws Exception {
    ...
    final String MASTER_TABLE_NM = "RI020NM";
    final String MASTER_UPDATE_ID = PRORAM_ID + ".UPDATE_" + MASTER_TABLE_NM;
    final String SUB_TABLE_NM = "RI030NM";
    final String UPDATE_ID = PRORAM_ID + ".UPDATE_" + SUB_TABLE_NM;
