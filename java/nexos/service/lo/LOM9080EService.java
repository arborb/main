...
/**
 * Class: LOM9080EService<br>
 * Description: 재고실사(LOM9080E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("LOM9080E")
public class LOM9080EService {

  /**
   * DAO 주입처리하기
   */
  @Resource
  private LOM9080EDAO                dao;
   ...
   */
  @SuppressWarnings("unchecked")
  public String callAllHasUpdate(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "LO_HAS_CONFIRM_PROC";
    List<Map<String, Object>> spcallDS = (List<Map<String, Object>>)params.get(Consts.PK_DS_MASTER);
    String user_Id = (String)params.get(Consts.PK_USER_ID);
   ...
   */
  @SuppressWarnings("unchecked")
  public String callAllHasCancel(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "LO_HAS_CANCEL_PROC";
    List<Map<String, Object>> spcallDS = (List<Map<String, Object>>)params.get(Consts.PK_DS_MASTER);
    String user_Id = (String)params.get(Consts.PK_USER_ID);
