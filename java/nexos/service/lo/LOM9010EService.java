...
/**
 * Class: LOM9010EService<br>
 * Description: 출고 취소처리(LOM9010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
...
public class LOM9010EService {
   ...
   * @throws Exception
   */
  public String callLoCancel(String queryId, Map<String, Object> params) throws Exception {
