...
/**
 * Class: LOM7050EService<br>
 * Description: 롯데백화점 센터스캔처리(LOM7050E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
...
public class LOM7050EService {
   ...
   * @throws Exception
   */
  public String callInspectProc(String queryId, Map<String, Object> params) throws Exception {
