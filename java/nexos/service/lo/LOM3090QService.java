...
/**
 * Class: LOM3090QService<br>
 * Description: 온라인 출고예정작업(LOM3090Q) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("LOM3090Q")
public class LOM3090QService {

  /**
   * DAO 주입처리하기 
   */
  @Resource
  private LOM3090QDAO                dao;
  ...
  public String callDealItemUpdate(Map<String, Object> params) throws Exception {

    final String PROCEDURE_ID = "LO_DEALITEM_CHANGE";
