...
/**
 * Class: LS06010QDAOImpl<br>
 * Description: LS06010Q DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("LS06010QDAO")
public class LS06010QDAOImpl implements LS06010QDAO {
    ...
    public void save(Map<String, Object> params) throws Exception {
        ...
        final String PRORAM_ID = "LS06010Q";
    ...
    public Map callDelete(Map<String, Object> params) throws Exception {
      ...
      final String LS_DELETE = "LS06010Q_DEAL_DELETE";

      return nexosDAO.callSP(LS_DELETE, params);
    }
}
