...
/**
 * Class: RO02010EService<br>
 * Description: 반출작업(RO02010E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("RO02010E")
public class RO02010EService {

  // private final Logger logger = LoggerFactory.getLogger(RO02010EService.class);

  /**
   * DAO 주입처리하기
   */
  @Resource
  private RO02010EDAO                dao;
