...
/**
 * Class: LF01030EDAOImpl<br>
 * Description: LF01030E DAO (Data Access Object)<br>
 ...
 * </pre>
 */
@Repository("LF01030EDAO")
public class LF01030EDAOImpl implements LF01030EDAO {
  ...
  public void save(Map<String, Object> params) throws Exception {
    ...
    final String PRORAM_ID = "LF01030E";
    final String TABLE_NM = "LFAMOUNT";
  ...
  public Map callAdjustInsert(Map<String, Object> params) throws Exception {
    ...
    final String ADJUST_INSERT = "LF_PROCESSING_ACCOUNT_START";

    return nexosDAO.callSP(ADJUST_INSERT, params);
  }
}
