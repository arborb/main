...
/**
 * Class: CS01000EService<br>
 * Description: 공지사항 관리(CS01000E) 서비스를 담당하는 Class(트랜잭션처리 담당)<br>
 ...
 */
@Service("CS01000E")
public class CS01000EService {

  // private final Logger logger = LoggerFactory.getLogger(CS01000EService.class);

  /**
   * DAO 주입처리하기 
   */
  @Resource
  private CS01000EDAO                dao;
