...
/**
 * Class: Util<br>
 * Description: 각종 Java Util 모음 Class<br>
...
public class Util {
  ...
  /**
   * 문자열 앞뒤로 "를 붙여서 리턴, 문자열이 null일 경우 문자열 null을 리턴
   * 
   * @param value
   * @return
   */
  public static String getQuotedStr(String value) {
   ...
   * @return
   */
  public static String getQuotedStr(Object value) {
  ...
  public static String getErrorMessage(Exception e) {
    ...
    return getNull(e.getMessage(), "Null Pointer Exception");
  }
   ...
   * @return
   */
  public static String getPathName(String... pathList) {
    ...
    if (Consts.FILE_SEPARATOR_UNIX.equals(File.separator)) {
  ...
  public static boolean renameFile(File fromFile, File toFile) {
    ...
    if (toFile.exists()) {
      String toFileName = toFile.getPath() + "." + getNowDate("yyyyMMddHHmmss");
   ...
   * @param pathList
   */
  public static void createDir(String... pathList) {
  ...
  /**
   * SELECT한 데이터를 파라메터 값으로 변경
   * 
   * @param params
   * @return
   */
  @SuppressWarnings("rawtypes")
  public static Map dataMapToParamMap(Map<String, Object> params) {
    ...
    while (iterator.hasNext()) {
      ...
      resultMap.put("P_" + key, params.get(key));
    }
    return resultMap;
  }

  /**
   * 입력값인 문자열이 null일 경우 replaceValue 값으로 바꿔서 리턴
   * 
   * @see getValue(String)
   * @param value 체크할 문자열
   * @param replaceValue null일때 되돌려 줄 문자값
   * @return String
   * @exception
   */
  public static String getValue(String value, String replaceValue) {
  ...
  public static boolean isIE(String userAgent) {
    ...
    return (userAgent.indexOf("MSIE") > -1 || userAgent.indexOf("RV") > -1);
  }
   ...
   * @throws Exception
   */
  public static int getNullZeroInt(String value) throws Exception {
  ...
  /**
   * 문자열을 치환처리하기<br>
   * (jdk 1.4에서 미지원으로 별도로 구현된 메소드)
   * 
   * @param str 치환대상이 될 문자열
   * @param pattern 치환할 문자 패턴
  ...
  /**
   * 입력값인 문자열이 null일 경우 replaceValue 값으로 바꿔서 리턴한다.
   * 
   * @see getNull(String)
   * @param value 체크할 문자열
   * @param replaceValue null일때 되돌려 줄 문자값
   ...
   * @exception
   */
  public static String getNull(String value, String replaceValue) {
   ...
   * @see getNull(String)
   * @param value 체크할 문자열
   * @param changeValue null일때 되돌려 줄 문자값
   * @return String
   * @exception
   */
  // public static String getNullNoneTrim(String value, String changeValue) {
  // try {
  // if (value == null) {
  // return changeValue;
  // }
   ...
   * @exception
   */
  // public static String getNullHtmlSpace(String value) {
  // try {
  // if (value == null) {
  // return "&nbsp;";
  // }
   ...
   * @exception
   */
  // public static String getNullSpace(String value) {
  // try {
  // if (value == null) {
  // return " ";
  // }
   ...
   * @exception
   */
  // public static int getNullOne(String value) {
  // try {
  // if (value == null) {
  // return 1;
  // }
   ...
   * @exception
   */
  // public static BigDecimal getBigDecimalNull(String value) {
  // try {
  // if (value == null) {
   ...
   * @exception
   */
  // public static String getAlertMsg(String value) {
  // String resultValue = getNull(value);
  // int len = resultValue.length();
  // StringBuffer result = new StringBuffer();
  // for (int i = 0; i < len; i++) {
  // if (resultValue.charAt(i) == '\n') {
  // result.append("\\n");
  // } else if (resultValue.charAt(i) == '"') {
  // result.append("'");
  // } else {
  // result.append(resultValue.charAt(i));
  // }
  // }
  // return result.toString();
  // }
  ...
  // // formatter = new SimpleDateFormat(SystemInfo.DateFormat,
  // // Locale.KOREA);
  // formatter = new SimpleDateFormat(Consts.DATE_FORMAT, Locale.KOREA);
  // date = formatter.parse(stDate);
  // strReturn = formatterReturn.format(date);
  // } catch (Exception ei) {
  ...
  // * }
  // */
  // throw new Exception("[날짜형식에 오류가 발생하였습니다.]");
  // }
  //
  // }
  //
  ...
  // return Util.getDate(stDate, stFormat, Consts.DATETIME_FORMAT);
  // }
  ...
  // return date.substring(0, 4) + Consts.DATE_SEPARATOR + date.substring(4, 6) + Consts.DATE_SEPARATOR
  // + date.substring(6, 8);
  // }
  ...
  // if (stFormat == null || stFormat.trim().equals("")) {
  // stFormat = Consts.DATETIME_FORMAT;
  // }
  // SimpleDateFormat formatter = new SimpleDateFormat(stFormat, Locale.KOREA);
  // return formatter.format(new Date());
  // }
  ...
  // } else {
  // if (stDate.length() != 8) {
  // throw new Exception("일시를 8자리로 입력하십시오.");
  // // throw new
  // // Exception(com.asetec.common.GetMessageFromResource.getMessage("App.Log.L01003"));
  // }
  ...
  // // Exception(com.asetec.common.GetMessageFromResource.getMessage("App.Log.L01003"));
  // }
  // return stDate.substring(0, 4) + Consts.DATE_SEPARATOR + stDate.substring(4, 6) + Consts.DATE_SEPARATOR
  // + stDate.substring(6, 8);
  // }
  // }
   ...
   */
  // public static void writeObject(String path, String name, Object o) throws IOException, FileNotFoundException {
   ...
   */
  // public static Object readObject(String path, String name) throws IOException, FileNotFoundException,
  ...
  // String date = sDate[1] + "년 " + sDate[2] + "월 " + sDate[3] + "일 " + sDate[4] + "시 " + sDate[5] + "분 " + sDate[6]
  // + "초";
  // /*
  // * String date = "";
  // * try{
  ...
  // fsDay = fsDay + fday;
  // return day.get(Calendar.YEAR) + Consts.DATE_SEPARATOR + fsMonth + Consts.DATE_SEPARATOR + fsDay;
  // }
  ...
  // // throw new
  // // Exception(GetMessageFromResource.getMessage("App.Err.E02003"));
  // }
  //
  ...
  //
  // StringTokenizer st = new StringTokenizer(sysdate, Consts.DATE_SEPARATOR);
  // sysdate = st.nextToken() + st.nextToken() + st.nextToken();
  // Date param_date1 = fmt.parse(sysdate);
  //
  // st = new StringTokenizer(strDate, Consts.DATE_SEPARATOR);
  ...
  // strSepterator = Consts.DATE_SEPARATOR;
  // SimpleDateFormat fmt = new SimpleDateFormat("yyyyMMdd");
  //
  ...
  // if (strValue.replaceAll(Consts.DATE_SEPARATOR, "").length() == 8)
  // return (new SimpleDateFormat(Consts.DATE_FORMAT)).parse(strValue);
  // else
  // return (new SimpleDateFormat(Consts.DATETIME_FORMAT)).parse(strValue);
  // }
