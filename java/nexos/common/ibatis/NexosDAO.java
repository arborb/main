...
public class NexosDAO {
	 ...
	 * @return 데이터 건수
	 */
	public int listToExcel(String queryId, HSSFWorkbook xlsWorkbook,
			List<Map<String, Object>> grdColumns, String xlsExportType,
			String xlsTitle) {

		return listToExcel(queryId, null, xlsWorkbook, grdColumns,
				xlsExportType, xlsTitle);
	}
	 ...
	 * @return 데이터 건수
	 */
	public int listToExcel(String queryId, Map<String, Object> map,
			HSSFWorkbook xlsWorkbook, List<Map<String, Object>> grdColumns,
			String xlsExportType, String xlsTitle) {

		ExcelRowHandler rowHandler = new ExcelRowHandler(xlsWorkbook,
				grdColumns, xlsExportType, xlsTitle);
		sqlMapClientTemplate.queryWithRowHandler(queryId, map, rowHandler);
