...
import nexos.service.lo.LOM7040EService;
...
/**
 * Class: 롯데백화점 집하장스캔처리 컨트롤러<br>
 * Description: 롯데백화점 집하장스캔처리 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOM7040E")
public class LOM7040EController extends CommonController {

  @Resource
  private LOM7040EService service;
   ...
   *            조회조건
   */
  @RequestMapping(value = "/Ship_cancel.do", method = RequestMethod.POST)
  public ResponseEntity<String> callDelete(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.Ship_cancel(queryId, params));
    } catch (Exception e) {
