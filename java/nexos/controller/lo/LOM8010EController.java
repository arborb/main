...
import nexos.service.lo.LOM8010EService;
...
/**
 * Class: 팔레타이징 컨트롤러<br>
 * Description: 팔레타이징 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOM8010E")
public class LOM8010EController extends CommonController {

  @Resource
  private LOM8010EService service;
