...
import nexos.service.lo.LOM3090QService;
...
@Controller
@RequestMapping("/LOM3090Q")
public class LOM3090QController extends CommonController {

  
    @Resource
    private LOM3090QService service;
     ...
     * @return
     */
    @RequestMapping(value = "/callDealItemUpdate.do", method = RequestMethod.POST)
    public ResponseEntity<String> callDealItemUpdate(HttpServletRequest request,
      ...
      try {
        ...
        result = getResponseEntity(request, service.callDealItemUpdate(params));
      } catch (Exception e) {
        result = getResponseEntityError(request, e);
      }
