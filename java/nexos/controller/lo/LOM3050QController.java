...
import nexos.service.lo.LOM3050QService;
...
/**
 * Class: 온라인 집계출고내역 컨트롤러<br>
 * Description: 온라인 집계출고내역 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LOM3050Q")
public class LOM3050QController extends CommonController {

    @Resource
    private LOM3050QService service;
