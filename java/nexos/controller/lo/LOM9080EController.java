...
import nexos.service.lo.LOM9080EService;
 ...
 */
@Controller
@RequestMapping("/LOM9080E")
public class LOM9080EController extends CommonController {

  @Resource
  private LOM9080EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callAllHasUpdate.do", method = RequestMethod.POST)
  public ResponseEntity<String> callAllHasUpdate(HttpServletRequest request,
      @RequestParam(Consts.PK_DS_MASTER) String masterDS, @RequestParam(Consts.PK_USER_ID) String user_Id) {
    ...
    try {
      result = getResponseEntity(request, service.callAllHasUpdate(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
   ...
   * @return
   */
  @RequestMapping(value = "/callAllHasCancel.do", method = RequestMethod.POST)
  public ResponseEntity<String> callAllHasCancel(HttpServletRequest request,
      @RequestParam(Consts.PK_DS_MASTER) String masterDS, @RequestParam(Consts.PK_USER_ID) String user_Id) {
    ...
    try {
      result = getResponseEntity(request, service.callAllHasCancel(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
