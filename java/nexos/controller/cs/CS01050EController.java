...
import nexos.service.cs.CS01050EService;
...
/**
 * Class: 자동출력 프린터설정 컨트롤러<br>
 * Description: 자동출력 프린터설정 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CS01050E")
public class CS01050EController extends CommonController {

  @Resource
  private CS01050EService service;
  ...
  public ResponseEntity<String> save(HttpServletRequest request, @RequestParam(Consts.PK_DS_MASTER) String saveDS,
    @RequestParam(Consts.PK_DS_SUB) String subDS, @RequestParam(Consts.PK_REG_USER_ID) String user_Id) {
