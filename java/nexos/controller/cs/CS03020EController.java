...
import nexos.service.cs.CS03020EService;
 ...
 */
@Controller
@RequestMapping("/CS03020E")
public class CS03020EController extends CommonController {

  @Resource
  private CS03020EService service;
  ...
  public ResponseEntity<String> callBuProcessCopy(HttpServletRequest request,
      @RequestParam(Consts.PK_QUERY_ID) String queryId, @RequestParam(Consts.PK_QUERY_PARAMS) String queryParams) {
    ...
    try {
      result = getResponseEntity(request, service.callBuProcessCopy(queryId, params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
