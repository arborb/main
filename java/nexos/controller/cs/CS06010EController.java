...
import nexos.service.cs.CS06010EService;
...
/**
 * Class: 화면표시그룹 관리 컨트롤러<br>
 * Description: 화면표시그룹 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CS06010E")
public class CS06010EController extends CommonController {

  @Resource
  private CS06010EService service;
   ...
   * 저장 처리
   * @param request   HttpServletRequest
   * @param masterDS  화면표시그룹 DataSet
   * @param detailDS  메시지그룹 DataSet
   * @param user_Id   사용자ID
   * @return
   */
