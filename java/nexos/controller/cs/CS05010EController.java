...
import nexos.service.cs.CS05010EService;
 ...
 */
@Controller
@RequestMapping("/CS05010E")
public class CS05010EController extends CommonController {

    @Resource
    private CS05010EService service;
     ...
     * 저장 처리
     * @param request   HttpServletRequest
     * @param masterDS  그룹코드 DataSet
     * @param detailDS  상용코드 DataSet
     * @param user_Id   사용자ID
     * @return
     */
