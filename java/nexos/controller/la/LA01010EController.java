...
import nexos.service.la.LA01010EService;
...
/**
 * Class: 발주등록작업 컨트롤러<br>
 * Description: 발주등록작업 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LA01010E")
public class LA01010EController extends CommonController {

  @Resource
  private LA01010EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callRequestCreation.do", method = RequestMethod.POST)
  public ResponseEntity<String> callRequestCreation(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.callRequestCreation(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
   ...
   * @param params 조회조건
   */
  @RequestMapping(value = "/saveAdjust.do", method = RequestMethod.POST)
  public ResponseEntity<String> saveAdjust(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.saveAdjust(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
