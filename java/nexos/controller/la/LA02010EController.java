...
import nexos.service.la.LA02010EService;
...
/**
 * Class: 납품예약관리 컨트롤러<br>
 * Description: 납품예약관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LA02010E")
public class LA02010EController extends CommonController {

  @Resource
  private LA02010EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callAppointMentCancel.do", method = RequestMethod.POST)
  public ResponseEntity<String> callAppointMentCancel(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.callAppointMentCancel(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
