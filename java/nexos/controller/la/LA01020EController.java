...
import nexos.service.la.LA01020EService;
...
/**
 * Class: 발주확정작업 컨트롤러<br>
 * Description: 발주확정작업 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LA01020E")
public class LA01020EController extends CommonController {

  @Resource
  private LA01020EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callRequestConfirm.do", method = RequestMethod.POST)
  public ResponseEntity<String> callRequestConfirm(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.callRequestConfirm(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
