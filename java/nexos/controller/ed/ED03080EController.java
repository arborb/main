...
import nexos.service.ed.ED03080EService;
...
/**
 * Class: [수신]유통가공 관리<br>
 * Description: [수신]유통가공 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED03080E")
public class ED03080EController extends CommonController {

    @Resource
    private ED03080EService service;
