...
import nexos.service.ed.ED09060EService;
...
/**
 * Class: [송신]변동가용재고<br>
 * Description: [송신]변동가용재고 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED09060E")
public class ED09060EController extends CommonController {

  @Resource
  private ED09060EService service;
