...
import nexos.service.ed.ED09010EService;
...
/**
 * Class: [송신]재고가용재고<br>
 * Description: [송신]재고가용재고 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED09010E")
public class ED09010EController extends CommonController {

  @Resource
  private ED09010EService service;
