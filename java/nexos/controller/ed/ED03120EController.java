...
import nexos.service.ed.ED03120EService;
...
/**
 * Class: [수신]주문리스트 출고예정 관리<br>
 * Description: [수신]주문리스트 출고예정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED03120E")
public class ED03120EController extends CommonController {

  @Resource
  private ED03120EService service;
   ...
   * 조회조건
   */
  @RequestMapping(value = "/callEROrdertoReal.do", method = RequestMethod.POST)
