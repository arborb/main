...
import nexos.service.ed.ED09030EService;
...
/**
 * Class: [송신]출고주문상태<br>
 * Description: [송신]출고주문상태 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED09030E")
public class ED09030EController extends CommonController {

  @Resource
  private ED09030EService service;
