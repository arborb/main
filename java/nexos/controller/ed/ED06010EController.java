...
import nexos.service.ed.ED06010EService;
...
/**
 * Class: [수신]안전재고마스터 관리<br>
 * Description: [수신]안전재고마스터 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED06010E")
public class ED06010EController extends CommonController {

  @Resource
  private ED06010EService service;
