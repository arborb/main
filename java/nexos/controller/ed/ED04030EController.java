...
import nexos.service.ed.ED04030EService;
...
/**
 * Class: [송신]반입확정 관리<br>
 * Description: [송신]반입확정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED04030E")
public class ED04030EController extends CommonController {

  @Resource
  private ED04030EService service;
