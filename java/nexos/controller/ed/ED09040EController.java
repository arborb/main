...
import nexos.service.ed.ED09040EService;
...
/**
 * Class: [송신]재고가용재고<br>
 * Description: [송신]브랜드별가용재고 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED09040E")
public class ED09040EController extends CommonController {

  @Resource
  private ED09040EService service;
