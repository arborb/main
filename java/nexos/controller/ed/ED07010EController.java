...
import nexos.service.ed.ED07010EService;
...
/**
 * Class: [송신]CJ대한통운 배송결과 관리<br>
 * Description: [송신]CJ대한통운 배송결과 관리 Controller
 ...
 */
@Controller
@RequestMapping("/ED07010E")
public class ED07010EController extends CommonController {

  @Resource
  private ED07010EService service;
