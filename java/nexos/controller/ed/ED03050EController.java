...
import nexos.service.ed.ED03050EService;
...
/**
 * Class: [수신]출고예정 관리<br>
 * Description: [수신]출고예정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED03050E")
public class ED03050EController extends CommonController {

  @Resource
  private ED03050EService service;
  ...
  @RequestMapping(value = "/callERProcessingClose.do", method = RequestMethod.POST)
  public ResponseEntity<String> callERProcessingClose(HttpServletRequest request,
      @RequestParam(Consts.PK_QUERY_ID) String queryId, @RequestParam(Consts.PK_DS_MASTER) String masterDS) {
    ...
    try {
      result = getResponseEntity(request, service.callERProcessingClose(queryId, params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
