...
import nexos.service.ed.ED03060EService;
...
/**
 * Class: [수신]반입예정 관리<br>
 * Description: [수신]반입예정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED03060E")
public class ED03060EController extends CommonController {

  @Resource
  private ED03060EService service;
