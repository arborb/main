...
import nexos.service.ed.ED04050EService;
...
/**
 * Class: [송신]기타입출고 관리<br>
 * Description: [송신]기타입출고 관리
 ...
 */
@Controller
@RequestMapping("/ED04050E")
public class ED04050EController extends CommonController {

  @Resource
  private ED04050EService service;
