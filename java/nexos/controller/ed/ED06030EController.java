...
import nexos.service.ed.ED06030EService;
...
/**
 * Class: [수신]출고주문상태 관리<br>
 * Description: [수신]출고주문상태 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED06030E")
public class ED06030EController extends CommonController {

  @Resource
  private ED06030EService service;
