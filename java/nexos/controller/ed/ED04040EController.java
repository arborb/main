...
import nexos.service.ed.ED04040EService;
...
/**
 * Class: [송신]반출확정 관리<br>
 * Description: [송신]반출확정 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/ED04040E")
public class ED04040EController extends CommonController {

  @Resource
  private ED04040EService service;
