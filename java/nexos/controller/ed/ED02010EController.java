...
import nexos.service.ed.ED02010EService;
 ...
 */
@Controller
@RequestMapping("/ED02010E")
public class ED02010EController extends CommonController {

    @Resource
    private ED02010EService service;
     ...
     * @param masterDS  수신정의 마스터 DataSet
     * @param detailDS  수신정의 디테일 DataSet
     * @param user_Id   사용자ID
     * 
    ...
    public ResponseEntity<String> saveBuCheck(HttpServletRequest request, @RequestParam(Consts.PK_DS_MASTER) String dataSet,
    ...
    public ResponseEntity<String> saveIdentifier(HttpServletRequest request, @RequestParam(Consts.PK_DS_MASTER) String dataSet,
            @RequestParam(Consts.PK_USER_ID) String user_Id) {
