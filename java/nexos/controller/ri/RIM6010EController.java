...
import nexos.service.ri.RIM6010EService;
...
/**
 * Class: 반입출고스캔검수 컨트롤러<br>
 * Description: 반입출고스캔검수 Controller<br>
 ...
 */
@Controller
@RequestMapping("/RIM6010E")
public class RIM6010EController extends CommonController {

  @Resource
  private RIM6010EService service;
   ...
   */
  @SuppressWarnings("rawtypes")
  @RequestMapping(value = "/callFWScanUpdate.do", method = RequestMethod.POST)
  public ResponseEntity<String> callFWScanUpdate(HttpServletRequest request,
    @RequestParam(Consts.PK_QUERY_PARAMS) String queryParams) {
    ...
    try {
      Map mapResult = service.callFWScanUpdate(params);
      result = getResponseEntity(request, mapResult);
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
