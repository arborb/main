...
import nexos.service.ri.RIM2010EService;
...
/**
 * Class: 온라인온라인반입작업 컨트롤러<br>
 * Description: 온라인온라인반입작업 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/RIM2010E")
public class RIM2010EController extends CommonController {

  @Resource
  private RIM2010EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callRIOrderSp.do", method = RequestMethod.POST)
  public ResponseEntity<String> callRIOrderToReal(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.callRIOrderSp(params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
  ...
  /**
   * 온라인온라인반입등록 - 온라인온라인반입등록 마스터/디테일 저장 처리
   * 
   * @param request HttpServletRequest
   * @param subDS DataSet
   * @param user_Id 사용자ID
  ...
  public ResponseEntity<String> save(HttpServletRequest request, @RequestParam(Consts.PK_DS_MASTER) String masterDS,
    ...
    // 온라인온라인반입등록 디테일 DataSet Map에 추가
    ...
    // 온라인온라인반입등록 마스터 DataSet Map에 추가
    ...
    // 빈압부가정보 마스터(온라인고객) DataSet Map에 추가
  ...
  /**
   * 온라인온라인반입확정/적치 - 온라인온라인반입지시 저장 처리
   * 
   * @param request HttpServletRequest
   * @param subDS DataSet
   * @param user_Id 사용자ID
