...
import nexos.service.lf.LF03020EService;
...
/**
 * Class: 배송청구수수료 조정<br>
 * Description: 배송청구수수료 조정 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF03020E")
public class LF03020EController extends CommonController {

    @Resource
    private LF03020EService service;
