...
import nexos.service.lf.LF03040EService;
...
/**
 * Class: 위탁수수료 합계 조정<br>
 * Description: 위탁수수료 합계 조정 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF03040E")
public class LF03040EController extends CommonController {

    @Resource
    private LF03040EService service;
