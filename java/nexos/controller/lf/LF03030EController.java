...
import nexos.service.lf.LF03030EService;
...
/**
 * Class: 배송지급수수료 조정<br>
 * Description: 배송지급수수료 조정 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF03030E")
public class LF03030EController extends CommonController {

    @Resource
    private LF03030EService service;
