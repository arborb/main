...
import nexos.service.lf.LF02010EService;
...
/**
 * Class: 정산마스터 관리 컨트롤러<br>
 * Description: 정산마스터 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF02010E")
public class LF02010EController extends CommonController {

    @Resource
    private LF02010EService service;
     ...
     * 저장 처리
     * @param request   HttpServletRequest
     * @param masterDS  정산코드 DataSet
     * @param detailDS  세부코드 DataSet
     * @param user_Id   사용자ID
     * @return
     */
