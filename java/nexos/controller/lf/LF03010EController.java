...
import nexos.service.lf.LF03010EService;
...
/**
 * Class: 일자별 위탁청구수수료 조정<br>
 * Description: 위탁청구수수료 조정 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF03010E")
public class LF03010EController extends CommonController {

    @Resource
    private LF03010EService service;
