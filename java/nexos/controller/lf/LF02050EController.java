...
import nexos.service.lf.LF02050EService;
...
/**
 * Class: 배송청구수수료 관리 컨트롤러<br>
 * Description: 배송청구수수료 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF02050E")
public class LF02050EController extends CommonController {

  @Resource
  private LF02050EService service;
  ...
  public ResponseEntity<String> save(HttpServletRequest request, @RequestParam(Consts.PK_DS_MASTER) String masterDS,
    ...
    // 보관유형/상품그룹/상품별 기준수수료 DataSet Map에 추가
