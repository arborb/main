...
import nexos.service.lf.LF06020QService;
...
/**
 * Class: 지급수수료 합계내역<br>
 * Description: 지급수수료 합계내역 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LF06020Q")
public class LF06020QController extends CommonController {

    @Resource
    private LF06020QService service;
