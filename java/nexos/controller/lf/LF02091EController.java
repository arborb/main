...
import nexos.service.lf.LF02091EService;
 ...
 */
@Controller
@RequestMapping("/LF02091E")
public class LF02091EController extends CommonController {

    @Resource
    private LF02091EService service;
    ...
    @RequestMapping(value = "/callBrandCopy.do", method = RequestMethod.POST)
    public ResponseEntity<String> callBrandCopy(HttpServletRequest request,
      ...
      try {
        Map mapResult = service.callBrandCopy(params);
