...
import nexos.service.cm.CM03050EService;
...
/**
 * Class: 배송처배송기준관리 컨트롤러<br>
 * Description: 배송처배송기준관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CM03050E")
public class CM03050EController extends CommonController {

  @Resource
  private CM03050EService service;
