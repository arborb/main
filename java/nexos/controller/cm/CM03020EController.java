...
import nexos.service.cm.CM03020EService;
 ...
 */
@Controller
@RequestMapping("/CM03020E")
public class CM03020EController extends CommonController {

  @Resource
  private CM03020EService service;
   ...
   * @param params 조회조건
   */
  @RequestMapping(value = "/setOwnBrandCreate.do", method = RequestMethod.POST)
  public ResponseEntity<String> setOwnBrandCreate(HttpServletRequest request,
    @RequestParam(Consts.PK_QUERY_ID) String queryId, @RequestParam(Consts.PK_QUERY_PARAMS) String queryParams) {
    ...
    try {
      result = getResponseEntity(request, service.setOwnBrandCreate(queryId, params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
