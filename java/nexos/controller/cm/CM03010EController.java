...
import nexos.service.cm.CM03010EService;
...
/**
 * Class: 위탁사 관리 컨트롤러<br>
 * Description: 위탁사 관리 Controller<br>
 ...
 */
@Controller
@RequestMapping("/CM03010E")
public class CM03010EController extends CommonController {

  @Resource
  private CM03010EService service;
   ...
   * @param params     조회조건
   */
  @RequestMapping(value = "/setBasicMasterCreate.do", method = RequestMethod.POST)
  public ResponseEntity<String> setBasicMasterCreate(HttpServletRequest request,
      @RequestParam(Consts.PK_QUERY_ID) String queryId, @RequestParam(Consts.PK_QUERY_PARAMS) String queryParams) {
    ...
    try {
      result = getResponseEntity(request, service.setBasicMasterCreate(queryId, params));
    } catch (Exception e) {
      result = getResponseEntityError(request, e);
    }
