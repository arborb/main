...
import nexos.service.cm.CM07030EService;
 ...
 */
@Controller
@RequestMapping("/CM07030E")
public class CM07030EController extends CommonController {

  @Resource
  private CM07030EService service;
   ...
   * @return
   */
  @RequestMapping(value = "/callItemBuMatchOwnBrand.do", method = RequestMethod.POST)
  public ResponseEntity<String> callItemBuMatchOwnBrand(HttpServletRequest request,
    ...
    try {
      result = getResponseEntity(request, service.callItemBuMatchOwnBrand(params));
    } catch (Exception e) {
