...
import nexos.service.li.LI05010EService;
...
/**
 * Class: 입고팔레트재분할 컨트롤러<br>
 * Description: 입고팔레트재분할 Controller<br>
 ...
 */
@Controller
@RequestMapping("/LI05010E")
public class LI05010EController extends CommonController {

    @Resource
    private LI05010EService service;
    ...
    @RequestMapping(value = "/setSplitPallet.do", method = RequestMethod.POST)
    public ResponseEntity<String> setSplitPallet(HttpServletRequest request, @RequestParam(Consts.PK_QUERY_PARAMS) String queryParams) {
        ...
        try {
            result = getResponseEntity(request, service.setSplitPallet(params));
        } catch (Exception e) {
            result = getResponseEntityError(request, e);
        }
